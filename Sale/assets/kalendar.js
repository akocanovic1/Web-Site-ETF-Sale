var mjesec = 0; //defaultna vrijednost mjeseca
...
//NAMJESTENA JE FUNKCIONALNOST CHECKBOXA - KADA KLIKNEMO CHECKBOX PRIKAZU SE PERIODICNA ZAUZECA//
    ...
    function iscrtajKalendarImpl(kalendarRef, mjesec){
        if(mjesec==100){
            for(i=0;i<nazivMjeseca.length;i++){
                var mj=document.getElementById("mjesec").innerText;
                //var postaviNazivMjeseca = kalendarRef.childNodes; 
                if(mj == nazivMjeseca[i] && i!=11){
                    mjesec=i+1;
                }
                if(mj == nazivMjeseca[i] && i==11){
                    mjesec=i;
...
Kalendar.ucitajPodatke([{"dan":"0", "semestar":"zimski", "pocetak":"13:00", "kraj":"14:00", "naziv":"1-01", "predavac":"xx"},
                       ...
                       [{"datum":"17.11.2020", "pocetak":"14:00", "kraj":"15:00", "naziv":"1-02", "predavac":"xx"},
                        {"datum":"20.11.2020", "pocetak":"15:00", "kraj":"18:00", "naziv":"1-02", "predavac":"xx"},
                        {"datum":"21.11.2020", "pocetak":"14:00", "kraj":"15:00", "naziv":"1-03", "predavac":"xx"},
                        {"datum":"21.09.2020", "pocetak":"14:00", "kraj":"15:00", "naziv":"EE1", "predavac":"xx"},
                        {"datum":"09.11.2020", "pocetak":"18:00", "kraj":"20:00", "naziv":"MA", "predavac":"xx"}]);
